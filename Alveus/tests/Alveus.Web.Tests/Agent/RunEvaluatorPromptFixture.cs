            ...
            return new ChatClientAgent(chatClient, new ChatClientAgentOptions
            {
                ...
                ChatOptions = new ChatOptions
                {
                    Instructions = "Tu es Alveus-Evaluator, l'agent de validation de Butlr. Tu reçois la même "
                        ...
                        + "Quand tu arrêtes de travailler, tu DOIS appeler l'outil Finish avec outcome='done' et : "
                        + "verdict='pass' si le jeu de test confirme que l'environnement répond à la consigne ; "
                        + "verdict='fail' si ce n'est pas le cas (reason=rapport détaillé des problèmes rencontrés, "
                        + "transmis à Alveus-Worker pour correction) ; verdict='needmoreinfo' si tu ne peux pas "
